  <div class="col-md-4 col-xl-3">
    <div class="sidebar px-4 py-md-0">
      ...
      <p class="small-3">This is a blog with a CMS that has been built in laravel, 
      it is purely to serve as a development playground for PHP development using Laravel Framework.
      </p>
